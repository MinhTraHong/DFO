...
namespace DFO.MainAPI.Infrastructure.Middlewares
{
    public class FailingMiddleware
    {
        ...
        private async System.Threading.Tasks.Task ProcessConfigRequest(HttpContext context)
        {
        ...
        private async System.Threading.Tasks.Task SendOkResponse(HttpContext context, string message)
        {
